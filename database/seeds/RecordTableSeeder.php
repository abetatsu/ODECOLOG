    ...
    public function run()
    {
        DB::table('records')->insert([
            ...
            [
                ...
                'size' => '6cm',
                'sleep_time' => '7時間',
                'care_item1' => 'エイチアンドエス フォーメン(h&s for men)',
                'care_item2' => 'スカルプDメカノバイオ',
                'care_item3' => 'VELEDA オーガニック ヘアオイル',
                'care_item4' => 'キュレル 頭皮保湿ローション',
                'alcohol' => '1合（180ml）未満',
                'stress' => 'ほぼない',
                'remarks' => '頭皮が柔らかい',
            ...
            [
                ...
                'size' => '6cm',
                'sleep_time' => '7時間',
                'care_item1' => 'SOLIMO スカルプD スカルプシャンプー',
                'care_item2' => 'セラミド化粧水 保湿 ミストスプレー',
                'care_item3' => '化粧水',
                'care_item4' => '乳液',
                'alcohol' => '1合（180ml）未満',
                'stress' => 'ほぼない',
